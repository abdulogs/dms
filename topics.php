...
<body class="fixed-nav sticky-footer" id="page-top">
                  ...
                  <div class="card shadow p-0 bg-white">
                    <div class="d-flex align-items-center p-3 border-bottom">
                      <h4 class="m-0 font-20 align-middle">
                        <i class="fa fa-list text-success"></i> Topics
                      </h4>
                    ...
                    <table class="table table-card table-sm mb-0">
                      <thead class="bg-light border-top">
                        <tr>
                          ...
                          <th class="border-0" scope="col" >Logo</th>
                          <th class="border-0" scope="col" >Technology</th>
  ...
  <?php require_once 'includes/footer.php'; ?>
    ...
    <script src="modules/topics/js/data.js"></script>
</body>
