...
class crud extends config
{
	...
	public static function check($table, $columns, $where, $type = "one")
	{
		$check = crud::select()::columns($columns)::table($table)::where($where)::execute();
		$check = crud::fetch($type);
		return $check;
	}
