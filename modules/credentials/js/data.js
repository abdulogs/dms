...
$(document).ready(function () {
  function loadData(page) {
    $.ajax({
      url: "modules/credentials/data.php",
      method: "POST",
      data: {
        page: page
      },
  ...
  $(document).on('click', '.createBtn', function (e) {
    $.ajax({
      url: "modules/credentials/form.php",
      type: "POST",
      cache: false,
      beforeSend: function () {
        $("#loading-bar").show();
  ...
  $(document).on('submit', '#create', function (e) {
    e.preventDefault();
    $.ajax({
      url: "modules/credentials/create.php",
      type: 'post',
  ...
  $(document).on("submit", "#update", function (e) {
    e.preventDefault();
    $.ajax({
      url: "modules/credentials/update.php",
      type: 'post',
      data: new FormData(this),
      contentType: false,
      processData: false,
  ...
  $(document).on('click', '.deleteBtn', function (e) {
    if (confirm("Do you really want to delete this!")) {
      var id = $(this).data('id');
      $.ajax({
        url: "modules/credentials/delete.php",
        type: 'post',
        data: {
          id: id
        },
