...
$(document).ready(function () {
  ...
  $(document).on('submit', '#create', function (e) {
    ...
    fd.append('description', $('.ql-editor').html());
    $.ajax({
      url: "modules/slides/create.php",
      type: 'post',
      data: fd,
      contentType: false,
      processData: false,
  ...
  $(document).on('click', '.deleteImage', function (e) {
    if (confirm("Do you really want to delete this!")) {
      ...
      $.ajax({
        url: "modules/slides/deleteImage.php",
        type: 'post',
        data: {
          id: id
        },
